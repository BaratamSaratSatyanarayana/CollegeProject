<html>
<body>
<form action="super.php" class="w6-container w6-card-4 w6-light-grey w6-text-yellow w6-margin" method="post">
...
<?php echo "&nbsp;&nbsp;&nbsp;&nbsp;";?>
   <a href="super.php?del=<?php echo $trow['email'];?>" onclick="return confirm('Are You Sure?');"><input type="button" class="submit" value="Delete profile"/></a>
</form>
<?php
}
if (isset($_GET['del'])) {	  
